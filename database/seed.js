...
async function seed() {
  ...
  const hashed = await bcrypt.hash('REDACTED', 10)
  ...
  console.log('\nDemo accounts:')
  console.log('  staff@nvr.gov      / REDACTED (role: staff)')
  console.log('  admin@nvr.gov      / REDACTED (role: admin)')
  console.log('  superadmin@nvr.gov / REDACTED (role: superadmin)')
